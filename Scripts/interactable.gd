...
# I need to add this node to whatever I want to interact with e.g. a box. I add it right under the root (not necessarily index 0, but needs to be a child, not grandchild)
